...
{
    class TheBulletThatKilledCorruption : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("The Bullet That Ended Corruption");
            Tooltip.SetDefault("");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.value = 10;
            item.rare = 2;
            item.shoot = mod.ProjectileType("TheBulletThatKilledCorruption");   //The projectile shoot when your weapon using this ammo
