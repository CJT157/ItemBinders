...
{
    class TheBulletThatKilledCrimson : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("The Bullet That Ended Crimson");
        ...
        public override void SetDefaults()
        {
            ...
            item.value = 10;
            item.rare = 2;
            item.shoot = mod.ProjectileType("TheBulletThatKilledCrimson");   //The projectile shoot when your weapon using this ammo
