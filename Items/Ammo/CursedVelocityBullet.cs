...
{
    class CursedVelocityBullet : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Cursed Velocity Bullet");
        ...
        public override void SetDefaults()
        {
            ...
            item.value = 10;
            item.rare = 2;
            item.shoot = mod.ProjectileType("CursedVelocityBullet");   //The projectile shoot when your weapon using this ammo
